...
# List #
########    
@view_config(route_name='notadinas-urusan', renderer='templates/urusan/list.pt',
             permission='notadinas-urusan')
...
# Action #
##########    
@view_config(route_name='notadinas-urusan-act', renderer='json',
             permission='notadinas-urusan-act')
...
def route_list(request):
    return HTTPFound(location=request.route_url('notadinas-urusan'))
...
@view_config(route_name='notadinas-urusan-add', renderer='templates/urusan/add.pt',
             permission='notadinas-urusan-add')
    ...
    if request.POST:
        if 'simpan' in request.POST:
            ...
            try:
                ...
                return HTTPFound(location=request.route_url('notadinas-urusan-add'))
...
@view_config(route_name='notadinas-urusan-edit', renderer='templates/urusan/edit.pt',
             permission='notadinas-urusan-edit')
...
# Delete #
##########    
@view_config(route_name='notadinas-urusan-delete', renderer='templates/urusan/delete.pt',
             permission='notadinas-urusan-delete')
