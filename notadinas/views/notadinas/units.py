...
# List #
########    
@view_config(route_name='notadinas-unit', renderer='templates/unit/list.pt',
             permission='notadinas-unit')
...
# Action #
##########    
@view_config(route_name='notadinas-unit-act', renderer='json',
             permission='notadinas-unit-act')
...
def route_list(request):
    return HTTPFound(location=request.route_url('notadinas-unit'))
...
@view_config(route_name='notadinas-unit-add', renderer='templates/unit/add.pt',
             permission='notadinas-unit-add')
    ...
    if request.POST:
        if 'simpan' in request.POST:
            ...
            try:
                ...
                return HTTPFound(location=request.route_url('notadinas-unit-add'))
...
@view_config(route_name='notadinas-unit-edit', renderer='templates/unit/edit.pt',
             permission='notadinas-unit-edit')
...
# Delete #
##########    
@view_config(route_name='notadinas-unit-delete', renderer='templates/unit/delete.pt',
             permission='notadinas-unit-delete')
