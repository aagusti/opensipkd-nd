...
SESS_ADD_FAILED = 'Tambah surat-inbox-item gagal'
SESS_EDIT_FAILED = 'Edit surat-inbox-item gagal'
...
# Action #
##########    
@view_config(route_name='notadinas-surat-inbox-item-act', renderer='json',
             permission='notadinas-surat-inbox-item-act')
...
# Add #
#######
@view_config(route_name='notadinas-surat-inbox-item-add', renderer='json',
             permission='notadinas-surat-inbox-item-add')
...
# Delete #
##########    
@view_config(route_name='notadinas-surat-inbox-item-delete', renderer='json',
             permission='notadinas-surat-inbox-item-delete')
...
# Download #
############    
@view_config(route_name='notadinas-surat-inbox-item-download', renderer='json',
             permission='notadinas-surat-inbox-item-download')
